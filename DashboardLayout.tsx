...
import { 
  MessageSquare, Shield, Globe, Map, User, Settings, 
  ChevronRight, PanelLeftClose, PanelLeftOpen, Terminal,
  History, Search, Plus, Bell, Command
} from 'lucide-react';
        ...
        <div className="flex-1 flex flex-col gap-4">
          {sidebarItems.map(item => (
            ...
            >
              ...
              <span className="absolute right-full mr-2 px-2 py-1 bg-slate-800 text-white text-[10px] rounded opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity whitespace-nowrap z-[100]">
                {item.label}
              </span>
            </button>
          ))}
